...
TOKEN = '7223886954:AAFGgcZOQLszNS5TyaSsybwnZzKFxDIKOSc'
...
FORWARD_CHANNEL_ID = -1002206909795
CHANNEL_ID = -1002206909795
error_channel_id = -1002206909795
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for NEW UPDATE : https://t.me/BLACKHOLEVIPGROUP*", parse_mode='Markdown')
